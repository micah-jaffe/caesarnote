        ...
        <ul>
          ...
          <li onClick={this.resetSearchQuery} className={"align-middle nav-link no-arrow" + (this.selectedNavLink() === 2 ? " selected-nav" : "")}>
            <Link className="align-middle" to="/main">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="nav">
                <path id="14a" d="M16 16h2v-1h-2a.997.997 0 0 0-1 1v3h1v-3zM8 4h8a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2zm1.5 4a.5.5 0 0 0 0 1h5a.5.5 0 1 0 0-1h-5zm0 3a.5.5 0 1 0 0 1h5a.5.5 0 1 0 0-1h-5zm0 3a.5.5 0 1 0 0 1h3a.5.5 0 1 0 0-1h-3z" />
              </svg>
              <span>All Notes</span>
            </Link>
          </li>
          ...
          <li onClick={this.handleNotebookClick} className={"align-middle nav-link" + (this.selectedNavLink() === 3 ? " selected-nav" : "")}>
            <Link className="align-middle" to="/main/notebooks">
              <div className={"align-middle" + (this.state.notebookDropdown ? " rotate" : "unrotate")}>
                <svg xmlns="http://www.w3.org/2000/svg" width="8" height="8" viewBox="0 0 8 8">
                  <path d="M2 0l4 4-4 4z" />
                </svg>
              </div>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path d="M9 4h7a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H9V4zM6 4h2v15H6V4zm5.5 4a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-4z" />
              </svg>
              <span>Notebooks</span>
            </Link>
          </li>
          ...
          <li onClick={this.props.openPaywall} className="align-middle nav-link no-arrow">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="nav">
              <path id="12a" d="M15.489 19h-11l.017-3.244s-.128-1.462 1.457-1.685c1.588-.223 2.837-.495 2.212-1.56-.578-.988-2.539-5.253.907-6.365a2.976 2.976 0 0 1 1.842 0c3.446 1.112 1.486 5.377.908 6.364-.625 1.066.624 1.338 2.21 1.561 1.587.223 1.459 1.685 1.459 1.685L15.489 19zm4.481 0h-3v-4c-.158-1.025-.862-1.525-2.11-1.502-.427-.704-1.895-3.985.638-4.779a2.27 2.27 0 0 1 1.355 0c2.532.794 1.093 3.835.667 4.54-.459.76.8.484 1.625 1.112C19.97 15 19.97 16 19.97 16v3z" />
            </svg>
          ...
          <li className={"align-middle nav-link no-arrow" + (this.selectedNavLink() === 5 ? " selected-nav" : "")}>
            <Link className="align-middle" to="/main/tags">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="nav">
                <path id="10a" d="M10.265 9.005a2 2 0 1 0 3.47 0H18v9.5a1.5 1.5 0 0 1-1.5 1.5h-9a1.5 1.5 0 0 1-1.5-1.5v-9.5h4.265zM9.5 16a.5.5 0 1 0 0 1h5a.5.5 0 1 0 0-1h-5zm0-2a.5.5 0 1 0 0 1h5a.5.5 0 1 0 0-1h-5zm4.235-4.995H18l-4.982-4.606a1.5 1.5 0 0 0-2.036 0L6 9.005h4.265a2 2 0 0 1 3.47 0z" />
              </svg>
              <span>Tags</span>
            </Link>
          </li>
          ...
          <li className="align-middle nav-link no-arrow">
            <Link className="align-middle" to="/main/trash">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="nav">
                <path id="8a" d="M5 7.496a.5.5 0 0 1 .5-.5L8.996 7V5.25c0-.69.305-1.25 1.008-1.25H14c.703 0 1 .556 1 1.247v1.75H18.5a.5.5 0 1 1 0 1h-13a.5.5 0 0 1-.5-.5zm5.25-2.001a.25.25 0 0 0-.25.25v1.002c0 .138.112.25.25.25h3.5a.25.25 0 0 0 .25-.25V5.745a.25.25 0 0 0-.25-.25h-3.5zm6.205 12.567c0 .69-.57.935-1.273.935H8.818c-.703 0-1.273-.56-1.273-1.25l-.548-8.748H17l-.546 9.063z" />
              </svg>
              <span>Trash</span>
            </Link>
          </li>
          ...
          <li onClick={this.props.openPaywall} className="align-middle nav-link no-arrow">
            <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" id="upgrade">
              <path d="M12 5a7 7 0 1 1 0 14 7 7 0 0 1 0-14zm-1.223 10.602c0 .18.126.313.3.374.175.06.37.005.485-.136l3.043-3.671c.084-.103.115-.238.084-.366a.428.428 0 0 0-.242-.29l-1.313-.715V8.396c0-.181-.136-.312-.31-.372a.442.442 0 0 0-.485.136l-3.043 3.671a.42.42 0 0 0 .158.656l1.323.713v2.402z" />
            </svg>
            <span>Upgrade</span>
          </li>
        </ul>
