  ...
  render() {
    return (
      <div className="nav-bar">
        <ul>
          <li onClick={this.props.openPaywall} className="align-middle nav-link">
          ...
          <li onClick={this.selectNavLink(3)} className={"align-middle nav-link" + (this.state.selectedNavLink === 3 ? " selected-nav" : "")}>
