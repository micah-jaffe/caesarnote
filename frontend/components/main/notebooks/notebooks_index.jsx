      ...
      <div className="notebooks-index-container">
        ...
        <header className="notebooks-index-header-container align-middle">
          ...
          <span className="align-middle">
            <button id="create-notebook-btn" className="align-middle" onClick={() => this.props.openModal('create_notebook')}>
            ...
            <span onClick={this.openPaywall}>
              <svg className="svg" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="#737373" id="47a" d="M8 16.793l-2.146-2.147-.708.708L8.5 18.707l3.354-3.353-.708-.708L9 16.793V5H8v11.793zM12 5h9v1h-9V5zm0 3h7v1h-7V8zm0 3h5v1h-5v-1z"></path></svg>
            </span>
          </span>
        </header>
